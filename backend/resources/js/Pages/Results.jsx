...
export default function Results({ auth, exam, score, answers }) {
    return (
                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 text-center">
                            ...
                            <div className="text-3xl font-black text-slate-900">75</div>
                        </div>
                        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 text-center">
                            <div className="text-slate-500 text-sm font-bold uppercase mb-2">Correct Answers</div>
                            <div className="text-3xl font-black text-accent">64</div>
                        </div>
                        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 text-center">
                            <div className="text-slate-500 text-sm font-bold uppercase mb-2">Time Taken</div>
                            <div className="text-3xl font-black text-primary">42:15</div>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href={`/exams/${exam.id}`} className="btn-primary py-4 px-10 text-lg shadow-2xl">
                            Retake Exam
                        </Link>
                        <Link href="/dashboard" className="px-10 py-4 bg-white text-slate-700 font-bold rounded-2xl border border-slate-200 hover:bg-slate-50 transition-all text-center">
                            Go to Dashboard
                        </Link>
                    </div>
                </div>
