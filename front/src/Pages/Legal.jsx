...
export default function Legal({ title }) {
    const getContent = () => {
        ...
        if (title.includes("Privacy")) {
            return (
                <>
                    <p className="mb-6">Your privacy is important to us. This policy explains how we collect, use, and protect your personal information when you use the Nursing Exam Source platform.</p>
        ...
        if (title.includes("Terms")) {
            return (
                <>
                    <p className="mb-6">By accessing and using the Nursing Exam Source website, you accept and agree to be bound by the terms and provision of this agreement.</p>
        ...
        return (
            <>
                ...
                <p className="mb-6">Nursing Exam Source provides study materials "as is" and does not guarantee specific exam results. Success depends on individual study habits and curriculum variations.</p>
            </>
        );
    };
        ...
        <div className="min-h-screen bg-white font-sans text-slate-900">
            ...
            <main className="pt-40 pb-32">
                <div className="max-w-4xl mx-auto px-4">
                    <h1 className="text-5xl font-black text-slate-950 mb-12 italic">{title}</h1>
                    <div className="prose prose-slate prose-xl font-medium text-slate-600 leading-relaxed">
                        {getContent()}
                    </div>
                </div>
            </main>
