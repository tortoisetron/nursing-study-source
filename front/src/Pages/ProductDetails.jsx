...
export default function ProductDetails() {
    ...
    if (!product) return <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans">Product not found.</div>;
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        ...
                        <div className="flex-1">
                            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                                <Link to="/test-bank" className="hover:text-primary transition-colors">Test Bank</Link>
                                <span>/</span>
